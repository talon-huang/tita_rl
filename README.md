...
>1. Isaac Gym仿真训练  
    ...
    代码仓：
    ```
    https://github.com/talon-huang/tita_rl.git
    ```
    2. sim2sim仿真
        使用sim2sim仿真，可以更快的检验isaac gym训练成果，为了安全，为了验证程序可行，还有很大程度上排除机器模型一致性问题，sim2sim没有太大的问题
        就可以开始实机部署
    代码仓：
    ```
    https://github.com/talon-huang/tita_webots_ros2.git
    ```
    3. sim2real仿真
...
一. 环境搭建（每个人的环境都不一样，一下尽可能的把注意事项写上，遇到问题可以先问AI，实在不行在Issues上反馈）
